...
void init(rack::Plugin *p) {
    ...
    p->addModel(createModel<WidgetMix>("Qwelk", "Mix", "Mix", UTILITY_TAG));
    p->addModel(createModel<WidgetColumn>("Qwelk", "Column", "Column", UTILITY_TAG));
    p->addModel(createModel<WidgetGate>("Qwelk", "Gate", "Gate", UTILITY_TAG));
